...
exports.savePassword = function(req,res){
    ...
    //var EncryptedPassword = Encrypt.dataEncrypt(password);
...
exports.checkUser = function(req,res){
   var password = req.body.password;
   //var EncryptedPassword = Encrypt.dataEncrypt(password);
   connection.find({$and:[{userID:req.body.userID},{password: password}]},function(err,data){
       if(err){
           throw err;
       }else{          
           if(!data.length){
